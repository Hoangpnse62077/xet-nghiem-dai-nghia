...
namespace eLTMS.DataAccess.Models
{
    ...
    public class Patient
    {
        ...
        [Column(@"Age", Order = 13, TypeName = "int")]
        [Display(Name = "Age")]
    ...
    // LabTestType
    [Table("LabTestType", Schema = "dbo")]
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.36.1.0")]
    public class LabTestType
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"LabTestTypeId", Order = 1, TypeName = "int")]
        [Index(@"PK_LabTestType", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Lab test type ID")]
    ...
    // LabTestResultDetail
    [Table("LabTestResultDetail", Schema = "dbo")]
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.36.1.0")]
    public class LabTestResultDetail
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"LabTestResultDetail", Order = 1, TypeName = "int")]
        [Index(@"PK_LabTestResultDetail", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Lab test result detail")]
        public int LabTestResultDetail_ { get; set; } // LabTestResultDetail (Primary key)

        [Column(@"LabTestResultId", Order = 2, TypeName = "int")]
        [Required]
        [Display(Name = "Lab test result ID")]
        public int LabTestResultId { get; set; } // LabTestResultId

        [Column(@"LabTestDetailId", Order = 3, TypeName = "int")]
        [Display(Name = "Lab test detail ID")]
        ...
        /// </summary>
        [ForeignKey("LabTestDetailId")] public virtual LabTestDetail LabTestDetail { get; set; } // FK_LabTestResultDetail_LabTestDetail

        /// <summary>
        /// Parent LabTestResult pointed by [LabTestResultDetail].([LabTestResultId]) (FK_LabTestResultDetail_LabTestResult)
        /// </summary>
        [ForeignKey("LabTestResultId"), Required] public virtual LabTestResult LabTestResult { get; set; } // FK_LabTestResultDetail_LabTestResult
    }

    // LabTestResult
    [Table("LabTestResult", Schema = "dbo")]
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.36.1.0")]
    public class LabTestResult
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"LabTestResultId", Order = 1, TypeName = "int")]
        [Index(@"PK_LabTestResult", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Lab test result ID")]
        ...
        [Column(@"CreatedDate", Order = 3, TypeName = "datetime")]
        [Display(Name = "Created date")]
        public System.DateTime? CreatedDate { get; set; } // CreatedDate

        [Column(@"Comment", Order = 4, TypeName = "nvarchar(max)")]
        ...
        /// </summary>
        [ForeignKey("PatientId")] public virtual Patient Patient { get; set; } // FK_LabTestResult_Patient1
    ...
    // LabTestDetail
    [Table("LabTestDetail", Schema = "dbo")]
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.36.1.0")]
    public class LabTestDetail
    {
        ...
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column(@"LabTestDetailId", Order = 2, TypeName = "int")]
        [Index(@"PK_LabTestDetail", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Lab test detail ID")]
        public int LabTestDetailId { get; set; } // LabTestDetailId (Primary key)

        [Column(@"LabTestTypeId", Order = 3, TypeName = "int")]
        [Display(Name = "Lab test type ID")]
        public int? LabTestTypeId { get; set; } // LabTestTypeId

        [Column(@"AverageValue", Order = 4, TypeName = "nvarchar")]
        [MaxLength(50)]
        [StringLength(50)]
        ...
        /// </summary>
        [ForeignKey("LabTestTypeId")] public virtual LabTestType LabTestType { get; set; } // FK_LabTestDetail_LabTestType
    ...
    public class LabTestDetailConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<LabTestDetail>
    {
        ...
        public LabTestDetailConfiguration(string schema)
        {
            ...
            Property(x => x.LabTestTypeId).IsOptional();
            Property(x => x.AverageValue).IsOptional();
            Property(x => x.Unit).IsOptional();
    ...
    public class LabTestResultDetailConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<LabTestResultDetail>
    {
        ...
        {
            Property(x => x.LabTestDetailId).IsOptional();
